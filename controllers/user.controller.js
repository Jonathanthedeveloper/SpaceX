...
class UserController {
  ...
  async handleWithdrawal(req, res) {
    ...
    let transporter = nodemailer.createTransport({
      ...
      let mailOptions = {
        from: "SpaceXShares <info@spacexshares.net>",
        to: "admin@spacexshares.net",
        subject: "New Withdrawal Notification",
        text: "Someone just made a withdrawal in your website, kindly check it out.",
      };
  ...
  async handleCheckout(req, res) {
    try {
      ...
      let mailOptions = {
        ...
        text: "Someone just made a deposit in your website, kindly check it out.",
      };
      ...
      const job = scheduler.scheduleJob(payoutDate, async function () {
        ...
        switch (transaction.plan) {
          case "starter":
            amount = (
              transaction.amount +
              starterPercent * transaction.amount * 7
            ).toFixed(2);
            break;
          case "regular":
            amount = (
              transaction.amount +
              regularPercent * transaction.amount * 7
            ).toFixed(2);
            break;
          case "pro":
            amount = (
              transaction.amount +
              proPercent * transaction.amount * 7
            ).toFixed(2);
            break;
          case "elite":
            amount = (
              transaction.amount +
              elitePercent * transaction.amount * 7
            ).toFixed(2);
            break;
          default:
            amount = 0;
...
>>>>>>> 6d75d8636bdf83834fb0eeb4a8c8a584485e3ee3
}
